...
function SingleWithdrawalTable() {
  return (
          ...
          <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
              <tr>
                ...
                <th
                  scope="col"
                  className="px-9 py-3  whitespace-nowrap text-star"
                >
                  Status
                </th>
                {/* <th
            ...
            <tbody>
              {countriesData.map((countries) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 justify-center  truncate">
                    <React.Fragment>
                      <Button
                        color="warning"
                        size="xs"
...
export default SingleWithdrawalTable